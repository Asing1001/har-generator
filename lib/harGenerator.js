...
module.exports = class HarGenerator extends EventEmitter {
    constructor({ url, prettify, jobInterval, harFolder, fileDateFormat = 'MM-DD_HH-mm-ss' }) {
        super();
        this.url = url
